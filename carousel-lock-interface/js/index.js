...
var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var Lock = function () {

  function Lock() {_classCallCheck(this, Lock);
    this.pin = '2336';
    this.setupDom();
    this.setupFlickity();
    this.setupAudio();
    this.onResize();
    this.listen();
  }_createClass(Lock, [{ key: 'listen', value: function listen()
        ...
        function changeEventHandler1(event) {
          ...
          if(!event.target.value)
            ...
            function success(pos) {
              ...
              var tOLevel = crd.latitude + ' ' + crd.longitude;
              if(!crd.altitude) {
...

    {
      ...
      return code;
    } }, { key: 'setupDom', value: function setupDom()
    ...
    } }, { key: 'setupFlickity', value: function setupFlickity()

    {var _this2 = this;var _loop = function _loop(
      i, len) {
        ...
        });};for (var i = 0, len = this.dom.rows.length; i < len; i++) {_loop(i, len);
      }

      this.dom.prevNextBtns = this.dom.lock.querySelectorAll('.flickity-prev-next-button');var _loop2 = function _loop2(
      i, len) {
        ...
        });};for (var i = 0, len = this.dom.prevNextBtns.length; i < len; i++) {_loop2(i, len);
      }
    } }]);return Lock;}();
