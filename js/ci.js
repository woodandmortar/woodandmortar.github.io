...
function changeEventHandler(event) {
    ...
    if(!event.target.value)
      ...
      document.getElementById("main-contact-form").action = "https://docs.google.com/forms/d/e/1FAIpQLSeTeaYejBbhJLXGmh5TlBxe8sntv1w7a173XxyXPXWxddo-eQ/formResponse";
      ...
      var task = document.getElementById('vresp3').innerHTML;
        ...
        $.ajax({
          url: "https://docs.google.com/forms/d/e/1FAIpQLSeTeaYejBbhJLXGmh5TlBxe8sntv1w7a173XxyXPXWxddo-eQ/formResponse",
          data:  { "entry.1242063844" : task , "entry.1508677969" : project , "entry.1254735733" : location },
          type: "POST",
          dataType: "xml",
          statusCode: {
            0: function () {
...
var email ="ci.lead.developer@gmail.com";
