...
function changeEventHandler(event) {
    ...
    if(!event.target.value)
      ...
      document.getElementById("main-contact-form").action = "https://docs.google.com/forms/d/e/1FAIpQLScUAIIj6nNQsoBA-QPkhz5afoxki-sZv7huQ7zlBMC2SoELNA/formResponse";
      ...
      var task = document.getElementById('vresp3').innerHTML;
        ...
        $.ajax({
          url: "https://docs.google.com/forms/d/e/1FAIpQLScUAIIj6nNQsoBA-QPkhz5afoxki-sZv7huQ7zlBMC2SoELNA/formResponse",
          data:  { "entry.499570521" : task , "entry.1171569547" : project , "entry.168757573" : location },
          type: "POST",
          dataType: "xml",
          statusCode: {
            0: function () {
...
var email ="jbridges14@gmail.com";
