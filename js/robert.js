...
function changeEventHandler(event) {
    ...
    if(!event.target.value)
      ...
      document.getElementById("main-contact-form").action = "https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBJ8OgrVskWaPlZBgafWkZgxEQKpbUQAeZQrjCbrWBjfiB7Q/formResponse";
      ...
      var task = document.getElementById('vresp3').innerHTML;
        ...
        $.ajax({
          url: "https://docs.google.com/forms/u/1/d/e/1FAIpQLSeBJ8OgrVskWaPlZBgafWkZgxEQKpbUQAeZQrjCbrWBjfiB7Q/formResponse",
...
var email ="robwmnelson@gmail.com";
