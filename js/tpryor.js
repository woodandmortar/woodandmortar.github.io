...
function changeEventHandler(event) {
    ...
    if(!event.target.value)
      ...
      document.getElementById("main-contact-form").action = "https://docs.google.com/forms/d/e/1FAIpQLSeZXtW4eJ_HloYsXL7C1WjxItndehVFaHwsdbIVOGYBM552Mg/formResponse";
      ...
      var task = document.getElementById('vresp3').innerHTML;
        ...
        $.ajax({
          url: "https://docs.google.com/forms/d/e/1FAIpQLSeZXtW4eJ_HloYsXL7C1WjxItndehVFaHwsdbIVOGYBM552Mg/formResponse",
          data:  { "entry.2114191371" : task , "entry.2021616635" : project , "entry.801336114" : location },
          type: "POST",
          dataType: "xml",
          statusCode: {
            0: function () {
...
var email ="tyrea.pryor@gmail.com";
